    ...
    <div className="min-h-screen bg-brand-bg">
      ...
      <div className="max-w-[1100px] mx-auto px-12 pt-12 pb-20 flex gap-9 items-start">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-9">
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-dark mb-4">What You Will Learn</h2>
        ...
        <div className="w-[280px] shrink-0 sticky top-6">
          <Card>
            <CardHeader className="pb-0">
              ...
              <CardDescription>Earn experience points by completing course activities.</CardDescription>
            </CardHeader>
            <CardContent className="pt-4">
              ...
              <div className="mt-5">
                <div className="flex justify-between mb-1.5">
                  <span className="text-[13px] font-semibold text-brand-dark">Your Progress</span>
                ...
                <p className="text-xs text-brand-body mt-2">Enroll to start tracking your progress.</p>
              </div>

              <div className="mt-5 bg-brand-bg rounded-md p-3 text-center">
                <p className="text-xs text-brand-body mb-1">Total Potential XP</p>
